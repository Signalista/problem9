...
from core.picodet.PaddleDetection.deploy.python.preprocess import decode_image
...
from core.picodet.PaddleDetection.deploy.python.utils import get_current_memory_mb
...
from pptracking.python.visualize import plot_tracking_dict
...
def mot_topdown_unite_predict_video(mot_detector,
    ...
    num_classes = mot_detector.num_classes
    assert num_classes == 1, 'Only one category mot model supported for uniting keypoint python.'
    data_type = 'mot'
